<template>
  <div id="app">
    <div class="heading">
      ...
      <p>
        (photos from <a href="https://unsplash.com/">unsplash</a> &amp; audios
        from <a href="https://soundbible.com/">soundbible</a>)
      </p>
    </div>
...
export default {
    ...
    return {
      ...
      musicPlaylist: [
        ...
        },
        {
          title: "my105",
          artist: "Original",
          url: "http://www.my105.ch/my105original-de.m3u",
        ...
        {
          title: "Radio 105 Fresh",
          artist: "Fresh Hits",
          url: "http://stream01.my105.ch/my105fresh.mp3",
  ...
  mounted: function() {
    ...
    // CDN
    if (document.getElementById("feather")) return; // was already loaded
    var scriptTag = document.createElement("script");
    scriptTag.src =
      "https://cdnjs.cloudflare.com/ajax/libs/feather-icons/4.7.3/feather.min.js";
    scriptTag.id = "feather";
